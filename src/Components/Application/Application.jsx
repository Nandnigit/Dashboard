...
function Application() {
  return (
    ...
    <div>
    <div className='Application_about_you'><i class="fa-solid fa-check-to-slot"></i>About You</div>
    <div className='Application_Jamming'><i class="fa-solid fa-2"></i>Next step: Attend the jamming session</div>
    </div>
    <div className='Application_last_div'>
    <div className='Application_left_part'>
       <div><i class="fa-solid fa-ellipsis"></i></div>
       <div><button>Continue Your Application to TEN</button></div>
       ...
       <div><button>What to expect <i class="fa-solid fa-greater-than"></i></button></div>
    </div>
